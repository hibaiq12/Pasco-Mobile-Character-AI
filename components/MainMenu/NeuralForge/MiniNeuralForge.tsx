...
import { 
    ...
    ScanFace, Eye, Speaker, Activity, HeartHandshake, Layers, Sword, MapPin, Save, ChevronRight, Sparkles
} from 'lucide-react';
import { InputField } from './Configuration/SharedComponents';
        ...
        <div className="h-full w-full bg-zinc-950 flex flex-col md:flex-row overflow-hidden relative font-sans text-zinc-200">
            ...
            `}>
                ...
                <div className="flex-1 overflow-y-auto custom-scrollbar p-3 space-y-2">
                    ...
                    <div className="h-20 md:h-0"></div> {/* Bottom spacer for mobile */}
                </div>
            </div>

            {/* === PANEL 2: EDITOR === */}
            {/* Hidden on Mobile if NO contact selected */}
            <div className={`
                        ...
                        <div className="flex-1 overflow-y-auto custom-scrollbar p-4 md:p-8 relative">
                             <div className="max-w-3xl mx-auto space-y-6 pb-20">
                                ...
                                {activeSection === 'dialogue' && (
                                    <div className="space-y-6 animate-fade-in relative z-10 h-full">
