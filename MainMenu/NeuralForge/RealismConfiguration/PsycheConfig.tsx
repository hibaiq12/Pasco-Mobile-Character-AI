...
export const PsycheConfig: React.FC<PsycheConfigProps> = ({ formData, setFormData }) => {
    return (
        <div className="space-y-4 bg-zinc-900/30 p-6 rounded-2xl border border-white/5 animate-fade-in backdrop-blur-sm">
            ...
            <div className="pt-4 border-t border-white/5 mt-4 grid grid-cols-1 md:grid-cols-2 gap-4 relative z-10">
                <Slider 
