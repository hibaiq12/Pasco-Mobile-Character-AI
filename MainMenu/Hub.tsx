...
const CharacterCard: React.FC<CharacterCardProps> = memo(({ 
  ...
  onEdit
   ...
   const displayDesc = translatedDesc !== descKey ? translatedDesc : (char.description || "No description available.");
   ...
   return (
      ...
      >
          ...
          <img 
              src={char.avatar || "https://picsum.photos/200/300"} 
